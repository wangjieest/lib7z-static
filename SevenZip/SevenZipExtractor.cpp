...
namespace SevenZip
{
    ...
    HRESULT SevenZipExtractor::ExtractArchive(const TString& destDirectory, ProgressCallback* callback)
    {
    ...
    HRESULT SevenZipExtractor::ExtractArchive(const CMyComPtr< IStream >& archiveStream, const TString& destDirectory, ProgressCallback* callback)
    {
